...
const IntroCard = () => {
  ...
  // Detect mobile for performance optimizations - run once on mount
  useEffect(() => {
    setIsHydrated(true);
  ...
  return (
    // OUTER CONTAINER - Simplified for mobile LCP
    <div className="flex flex-col items-center justify-center min-h-screen w-full p-4 py-8 overflow-hidden bg-black/5">
       
      {/* MOBILE: Static div instead of motion.div for faster FCP/LCP */}
      {isMobile && isHydrated ? (
        <div className="relative w-full max-w-[90vw] mx-auto bg-[#181818] border border-white/20 rounded-3xl p-6 pt-12 pb-14 shadow-lg flex flex-col justify-between">
          <MobileIntroContent />
        </div>
      ) : (
        <motion.div
...
// MOBILE-OPTIMIZED CONTENT: Static, no animations, minimal DOM
const MobileIntroContent = memo(() => (
  <>
    {/* Minimal corners on mobile */}
    <div className="absolute top-4 left-4 w-4 h-4 border-l-2 border-t-2 border-white/50 rounded-tl-lg pointer-events-none" />
    <div className="absolute top-4 right-4 w-4 h-4 border-r-2 border-t-2 border-white/50 rounded-tr-lg pointer-events-none" />
    <div className="absolute bottom-4 left-4 w-4 h-4 border-l-2 border-b-2 border-white/50 rounded-bl-lg pointer-events-none" />
    <div className="absolute bottom-4 right-4 w-4 h-4 border-r-2 border-b-2 border-white/50 rounded-br-lg pointer-events-none" />

    <div className="flex flex-col items-center gap-6 relative z-10 w-full">
      {/* LCP IMAGE - Optimized for mobile */}
      <div className="relative w-28 h-28 rounded-2xl overflow-hidden ring-2 ring-white bg-black">
        <Image 
          src="/images/reall.webp"
          alt="Shiva - Software Engineer"
          width={112}
      ...
      <div className="text-center space-y-4 w-full">
        <h1 className="text-3xl font-bold text-white tracking-tight">Shiva</h1>
        
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-black border border-white">
        ...
        <p className="text-lg text-white font-light">Software Engineer</p>

        <div className="flex items-center justify-center gap-2 text-slate-300 py-1">
          <FaEnvelope className="w-4 h-4 text-white shrink-0" />
          <span className="text-xs break-all">Shivapanday9616527173@gmail.com</span>
        </div>

        {/* Static social links - no motion */}
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          <a href="https://github.com/SHIWA6" className="rounded-xl bg-black border border-white w-10 h-10 flex items-center justify-center active:scale-95 transition-transform">
            <FaGithub className="w-5 h-5 text-slate-300" />
          </a>
          <a href="https://x.com/testcricforlife" className="rounded-xl bg-black border border-white w-10 h-10 flex items-center justify-center active:scale-95 transition-transform">
            <FaTwitter className="w-5 h-5 text-slate-300" />
          </a>
          <a href="https://leetcode.com/SHIWA6" className="rounded-xl bg-black border border-white w-10 h-10 flex items-center justify-center active:scale-95 transition-transform">
            <SiLeetcode className="w-5 h-5 text-slate-300" />
          </a>
          <a href="https://www.linkedin.com/in/shiva-pandey-41978a308" className="rounded-xl bg-black border border-white w-10 h-10 flex items-center justify-center active:scale-95 transition-transform">
    ...
    <div className="w-full mt-8">
      <div className="p-5 rounded-[1.25rem] bg-slate-800/50 border-2 border-black/50">
...
MobileIntroContent.displayName = 'MobileIntroContent';
